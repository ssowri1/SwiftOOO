...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "ssowri1"
  # spec.authors            = { "ssowri1" => "ssowri1@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/ssowri1"
  ...
  spec.source_files  = "SwiftOOO/**/*.{h,m}"
